...
SPECTACULAR_SETTINGS = {
    "TITLE": "MTG Card API",
    "DESCRIPTION": (
        "Serves the best available Magic: The Gathering card image for a given card name or oracle ID. "
        "Card scoring weighs language preference, print era, and image sharpness (Laplacian variance)."
    ),
    "VERSION": "1.0.0",
